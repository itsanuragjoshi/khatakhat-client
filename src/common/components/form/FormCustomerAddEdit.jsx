import styles from './formCustomerAddEdit.module.css';
...
const FormCustomerAddEdit = ({ initialInputValues, formId }) => {
    ...
    const { data: countries } = useFetchData(`${import.meta.env.VITE_APP_API_URI}/countries`);
    ...
    const { data: gstStates } = useFetchData(`${import.meta.env.VITE_APP_API_URI}/gstCodes`);
    ...
    return (
        <>
            ...
            <div className="btnToolbar">
                <Button btnType="submit" btnClass="btnPrimary" btnText="Save" btnClick={handleSubmit} />
